...
<head>
    ...
    <title>Mowing and Plowing</title>
</head>
...
<body>
        ...
        <div class="row">
            <div class="col-lg-6 curve-box-1">
              ...
              <div class="btn-group dropend flex-column">
                <span class="text-white my-2">We'll text you a link for the free app</span>
                  <button type="button" class="btn btn-light dropdown-toggle d-flex justify-content-between rounded-3"
    ...
    <!-- --- section-10 (online-chat-popup)---- -->
    <!-- <div class="container-fluid">
    <div class="row">
        <div class="col-md-12 p-4 d-flex justify-content-end">
          <div class="msg-notifications">
            <i class="fa-solid fa-1 circle-1"></i>
          </div>
            <input type="checkbox" id="check">
            <label class="chat-btn text-dark" for="check">

                <svg id="Group_9013" data-name="Group 9013" xmlns="http://www.w3.org/2000/svg" width="30" height="35" viewBox="0 0 34.214 39.557">
            ...
            <div class="wrapper">
                ...
                <div class="chat-form">
                    ...
                    <button class="btn submit-btn btn-success btn-block mt-3">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="conatiner-fluid bg-gray footer">
        <div class="container-lg">
            <div class="row py-5">
                ...
                {{-- <div class="col-lg-3 col-md-12 text-white ul-list">
              <div>
                <span class="fw-normal pb-2 border-bottom-green">Mowing & Plowing</span>
                <ul class="list-unstyled fs-13 mt-4">
                    <li class="mt-3"><a href="#" class="text-decoration-none text-white">About Us</a></li>
                    <li class="mt-3"><a href="#" class="text-decoration-none text-white">Contact</a></li>
                    <li class="mt-3"><a href="#" class="text-decoration-none text-white">Services</a></li>
                    <li class="mt-3"><a href="#" class="text-decoration-none text-white">FAQ</a></li>
                    <li class="mt-3"><a href="#" class="text-decoration-none text-white">Work with us</a></li>
                    <li class="mt-3"><a href="#" class="text-decoration-none text-white">Blog</a></li>
                </ul>
              </div>
            </div> --}}
                {{-- <div class="col-lg-1"></div> --}}
                {{-- <div class="col-lg-3 col-md-12 text-white my-md-0 my-3">
                <span class="fw-normal pb-2 border-bottom-green">Contact</span>
                <div class="mt-4">
                ...
                <div class="my-3">
                    <a href="#" class="text-white text-decoration-none d-flex"><i class="fa-solid fa-phone-volume me-2 pt-1"></i> <div class="fs-14">1-877-331-6188</div> </a>
                </div>
                <div>
                  <span class="mb-4 fw-normal pb-2 border-bottom-green">Connect with us</span>
                </div>
                <div class="row mt-4">
                    <div class="col-lg-8 col-md-4 col-sm-6 col-8 d-flex justify-content-between">
                        <a href="#" class="text-white"><i class="fa-brands fa-twitter fs-5"></i></a>
                        ...
                        <a href="#" class="text-danger"><i class="fa-brands fa-youtube circle"></i></a>
                    </div>
                    <div class="col-lg-4 col-md-8 col-sm-6 col-4"></div>
                </div>
            </div> --}}
